...
const reviewsCollection = client.db("partsManufacturer").collection("reviews");
const ordersCollection = client.db("partsManufacturer").collection("orders");
...
app.put("/users/:email", async (req, res) => {
  ...
  const cursor = await usersCollection.updateOne(email, updateData, options);
  res.send(cursor);
});
